...
public class PassengerRepositoryImpl extends QuerydslRepositorySupport implements IPassengerRepository {
    ...
    @Override
    public List<Passenger> fetchByName(String name) {
        // 1- JPAQuery : EntityManager 담당, JPQL 사용
    ...
    @Override
    public List<Passenger> fetchByGenderAndGreaterThanAge(String gender, String age) {
        // 1- JPAQuery : EntityManager 담당, JPQL 사용
        return new JPAQuery<Passenger>().select(passenger)
                .from(passenger)
    ...
    @Override
    public Long updateAge(String passengerId, String age) {
